...
const routes = [
  ...
  {
    path: '/canvas/circle',
    name: 'CanvasCircleView',
    component: () =>
      import(
        /* webpackChunkName: "canvas", webpackPrefetch: true */ '../views/3_canvas/CanvasCircleView.vue'
      )
  },
  {
    path: '/canvas/pr',
    ...
    component: () =>
      import(
        /* webpackChunkName: "canvas", webpackPrefetch: true */ '../views/3_canvas/CanvasPrView.vue'
      )
  }
]
